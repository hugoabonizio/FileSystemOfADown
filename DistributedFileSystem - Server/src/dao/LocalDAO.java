...
public class LocalDAO {
    ...
    @SuppressWarnings("")
    public Local read(Local arg) throws SQLiteException {
        Local file = null;
        ...
        if (statement.step()) {
            ...
            file.setPath(arg.getPath());
            file.setBody((String) statement.columnValue(1));
            file.setOwner(arg.getOwner());
        }
        updateRead_at(arg);
    ...
    public Integer mkdir(Local file) throws SQLiteException {
        ...
        statement.bind(2, file.getPath());
        statement.bind(3, file.getIs_dir());
        statement.bind(4, file.getCreated_at());
        statement.bind(5, file.getRead_at());
        statement.bind(6, file.getUpdated_at());
        statement.bind(7, file.getOwner());
        /*if (statement.step()) {
         return (Integer) statement.columnValue(0);
         }*/
        statement.step();
